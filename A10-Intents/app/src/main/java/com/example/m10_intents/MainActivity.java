...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtg = findViewById(R.id.MTG);
        steam = findViewById(R.id.steam);
        youtube = findViewById(R.id.youTube);

        wow.setOnClickListener(view -> goToUrl("https://worldofwarcraft.blizzard.com/en-us/"));

        mtg.setOnClickListener(view -> goToUrl("https://magic.wizards.com/en"));

        steam.setOnClickListener(view -> goToUrl("https://store.steampowered.com/"));

        youtube.setOnClickListener(view -> goToUrl("https://youtube.com"));

    }

    private void goToUrl(String address) {
        Log.w("Intents", "loading " + address);
    ...
    /*
     next section is all from the Intent sample.
     REGION
        /**
